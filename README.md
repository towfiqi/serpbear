...
| Service           | Cost          | SERP Lookup    | API | Additional |
| ----------------- | ------------- | -------------- | --- | |
...
| [Google Search Results Scraper by Apify](https://apify.com/apify/google-search-scraper) | Free plan with $5 prepaid usage | From $1.80/1,000 results | Yes | Add-ons: paid search results, business leads enrichment, AI visibility (AI Mode, AI Overviews, Perplexity, ChatGPT) |
