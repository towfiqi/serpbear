   ...
   return (
      <div>
         <div className="domKeywords flex flex-col bg-[white] rounded-md text-sm border mb-5">
                  ...
                  <ul className="">
                     <li className="inline-block mr-4">
                        <a
                           ...
                           onClick={() => {
                              refreshMutate({ ids: selectedKeywords });
                              setSelectedKeywords([]);
                           }}
                        >
                     ...
                     <li className="inline-block mr-4">
                        <a className="block px-2 py-2 cursor-pointer hover:text-indigo-600" onClick={() => setShowRemoveModal(true)}>
                     ...
                     <li className="inline-block mr-4">
                        <a className="block px-2 py-2 cursor-pointer hover:text-indigo-600" onClick={() => setShowAddTags(true)}>
            ...
            <div
               className={`domkeywordsTable domkeywordsTable--keywords 
            ...
            >
               <div className=" lg:min-w-[800px]">
                  ...
                  >
                     <span
                        ref={titleColumnRef}
                        className={`domKeywords_head_keyword flex-1 basis-[4rem] w-auto lg:flex-1 
                     ...
                     >
                        ...
                        <span
                           className={`inline-block lg:flex lg:items-center 
                  ...
                  <div className="domKeywords_keywords border-gray-200 min-h-[55vh] relative">
                     ...
                     {isLoading && <p className=" p-9 pt-[10%] text-center text-gray-500">Loading Keywords...</p>}
                  </div>
               </div>
            </div>
         </div>
         {showKeyDetails && showKeyDetails.ID && <KeywordDetails keyword={showKeyDetails} closeDetails={() => setShowKeyDetails(null)} />}
