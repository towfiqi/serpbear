         ...
         <Link href={`/domain/${slug}`} passHref={true}>
            <a className="flex flex-col lg:flex-row">
               <div className={`flex-1 p-6 flex ${!isConsoleIntegrated ? 'basis-1/3' : ''}`}>
                  <div
                     className="group domain_thumb w-20 h-20 mr-6 bg-slate-100 rounded
                  ...
                  >
                     ...
                     <img
                        ...
                        src={thumb || `https://www.google.com/s2/favicons?domain=${domain.domain}&sz=128`}
                        alt={domain.domain}
                     />
                  </div>
                  <div className="domain_details flex-1">
                     <h3 className="font-semibold text-base mb-2 max-w-[200px] text-ellipsis overflow-hidden" title={domain.domain}>
                        {domain.domain}
                     </h3>
                     {keywordsUpdated && (
               ...
               <div className="flex-1 flex flex-col p-4">
                  ...
                  <div className="dom_stats flex flex-1 font-semibold text-2xl p-4 pt-5 rounded border border-[#E9EBFF] text-center">
                     <div className="flex-1 relative">
                        <span className="block text-xs lg:text-sm text-gray-500 mb-1">Keywords</span>
                        {keywordCount}
                     </div>
                     <div className="flex-1 relative">
