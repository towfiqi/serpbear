   ...
   return (
      <div>
         <div className="domKeywords flex flex-col bg-[white] rounded-md text-sm border mb-5">
            <div
               className="domKeywords_filters py-4 px-6 flex flex-col justify-between
            ...
            >
               <div>
                  ...
                  <div className="insight_selector lg:hidden">
                     <SelectField
                        options={['stats', 'keywords', 'countries', 'pages'].map((d) => {
            ...
            <div className="domkeywordsTable domkeywordsTable--sckeywords styled-scrollbar w-full overflow-auto min-h-[60vh]">
               <div className=" lg:min-w-[800px]">
                  ...
                  <div className="domKeywords_keywords border-gray-200 min-h-[55vh] relative">
                     {['keywords', 'pages', 'countries', 'stats'].includes(activeTab) &&
                        insight &&
                        insightItems &&
                     ...
                     {isConsoleIntegrated && isLoading && <p className=" p-9 pt-[10%] text-center text-gray-500">Loading Insight...</p>}
                     {!isConsoleIntegrated && (
