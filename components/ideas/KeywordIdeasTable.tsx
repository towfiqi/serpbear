...
const IdeasKeywordsTable = ({
   ...
   return (
      <div>
            ...
            {selectedKeywords.length > 0 && (
               <div className="font-semibold text-sm py-4 px-8 text-gray-500 ">
                  ...
                  <div className="inline-block ml-2">
                     ...
                     <button
                        className={`inline-block px-2 py-1 rounded-e ${
                           addKeywordDevice === 'mobile' ? 'bg-indigo-100 text-blue-700' : 'bg-indigo-50 '
                        }`}
                  ...
                  <a className="inline-block px-2 py-2 cursor-pointer hover:text-indigo-600" onClick={() => addKeywordIdeasToTracker()}>
            ...
            <div className="domkeywordsTable domkeywordsTable--sckeywords styled-scrollbar w-full overflow-auto min-h-[60vh]">
               <div className=" lg:min-w-[800px]">
                  ...
                  <div className="domKeywords_keywords border-gray-200 min-h-[55vh] relative" data-domain={domain?.domain}>
                     ...
                     {isAdwordsIntegrated && isLoading && <p className=" p-9 pt-[10%] text-center text-gray-500">Loading Keywords Ideas...</p>}
         ...
         {showKeyDetails && showKeyDetails.uid && <IdeaDetails keyword={showKeyDetails} closeDetails={() => setShowKeyDetails(null)} />}
