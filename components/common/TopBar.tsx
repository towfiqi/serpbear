   ...
   return (
      ...
      >
         <h3 className={`p-4 text-base font-bold text-blue-700 ${isDomainsPage ? 'lg:pl-0' : 'lg:hidden'}`}>
            ...
            SerpBear
            <button className="px-3 py-1 font-bold text-blue-700  lg:hidden ml-3 text-lg" onClick={() => showAddModal()}>
               +
            </button>
         </h3>
         {!isDomainsPage && router.asPath !== '/research' && (
            <Link href={'/domains'} passHref={true}>
               <a
                  className=" right-14 top-2 px-2 py-1 cursor-pointer bg-[#ecf2ff] hover:bg-indigo-100 transition-all
