   ...
   return (
      <div className={`field--toggle w-full relative ${classNames}`}>
         <label className="relative inline-flex items-center cursor-pointer w-full justify-between">
            ...
            <input type="checkbox" value={value.toString()} checked={!!value} className="sr-only peer" onChange={() => onChange(!value)} />
            <div
               className="relative rounded-3xl w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-4
