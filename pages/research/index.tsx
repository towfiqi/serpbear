...
const Research: NextPage = () => {
   ...
   useEffect(() => {
      ...
      if (previousLang) {
         setLanguage(previousLang.toString());
      }
      if (previousSeedKeywords) {
         setSeedKeywords(previousSeedKeywords.join(','));
      }
      ...
      <div className={'Login'}>
         ...
         <div className=" w-full max-w-7xl mx-auto lg:flex lg:flex-row">
            <div className="sidebar w-full p-6 lg:pt-44 lg:w-1/5 lg:block lg:pr-0" data-testid="sidebar">
               ...
               <div
                  className={`sidebar_menu domKeywords max-h-96 overflow-auto styled-scrollbar p-4
            ...
            <div className="domain_kewywords px-5 lg:px-0 lg:pt-8 w-full">
               <div className="domain_kewywords_head w-full ">
                  <div className=" flex mt-12 mb-0 justify-between">
                     <h1 className=" font-bold mb-0 mt-0 pt-2 lg:text-xl lg:mb-6" data-testid="domain-header">
                        Research Keywords
                     </h1>
                     <button
