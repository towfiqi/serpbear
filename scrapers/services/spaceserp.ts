...
const spaceSerp: ScraperSettings = {
   ...
   scrapeURL: (keyword, settings, countryData) => {
      ...
      return `https://api.spaceserp.com/google/search?apiKey=${settings.scaping_api}&q=${encodeURIComponent(
         keyword.keyword,
      )}&pageSize=100&gl=${country}&hl=${lang}${location}${device}&resultBlocks=`;
   },
